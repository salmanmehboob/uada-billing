...
var DateTimePickers = function () {
    ...
    var _componentPickadate = function () {
        ...
        // set year dropdown for last 30 year
        var today = new Date();
        var minimunYear = today.getFullYear() - 31

        // console.log(minimunYear);
        $('.pickadate-year').pickadate({
            selectYears: 50,
            selectMonths: true,
            format: 'mm/dd/yyyy',
            // formatSubmit: 'yyyy/mm/dd',
            min: new Date(minimunYear, 12, 30),
            max: true,
            today: '',
            close: '',
            clear: '',
        ...
        // Calculate the maximum date (50 years from today)
        var maximumDate = new Date(today.getFullYear() + 50, today.getMonth(), today.getDate());

        $('.pickadate-year-future').pickadate({
            selectYears: 50,
            selectMonths: true,
            format: 'mm/dd/yyyy',
            min: new Date(minimunYear, 12, 30),
            max: maximumDate, // Set the maximum date to the calculated maximumDate
            today: '',
            close: '',
            clear: '',
        });
        ...
        var minimunYear = today.getFullYear() - 51
        $('.pickadate-year-general').pickadate({
            selectYears: 50,
            selectMonths: true,
            format: 'mm/dd/yyyy',
            // formatSubmit: 'yyyy/mm/dd',
        ...
        $('body').on('click', '.dateIcon', function () {
            var pickerID = $(this).data('id');
            if ($("#" + pickerID + "_root").hasClass("picker--opened")) {
                $("#" + pickerID + "_root").removeClass("picker--opened")

            } else {
                $("#" + pickerID + "_root").addClass("picker--opened")
            }
        });
