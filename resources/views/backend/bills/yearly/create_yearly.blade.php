...
@section('content')
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="{{route('show-bill-yearly')}}" class="breadcrumb-item">Stamp Duty Bills</a>
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <!-- Registration form -->
            <form action="{{route('store-bill-yearly')}}" method="post"
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label class="col-form-label  ">Select Charge (Per Year) <span
                                                class="text-danger">*</span> </label>
                                        <div
                                            class="form-group form-group-feedback form-group-feedback-right">
                                            <select data-placeholder="Select Charge" required
                                                    name="charge_type_id" id="charge_type_id"
                                                    class="form-control select-search mb-3 "
                                                    data-fouc>
                                                <option></option>
                                                @foreach($charges as $key =>  $row)
                                                    <option
                                                        value="{{$row->charge_id}}">{{$row->charge->name}}</option>
                                                @endforeach
                                            </select>
                                            @if ($errors->has('bank_id'))
                                                <span
                                ...
                                <div id="row-container">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <label class="col-form-label  ">Rate Per Year<span
                                                    class="text-danger">*</span> </label>
                                            <div
                                                class="form-group form-group-feedback form-group-feedback-right">
