        ...
        <div class="card">
            ...
            <div class="invoice" id="printInvoice">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table style="width: 438pt; height: 173pt">
                            ...
                            <tr>
                                <td class="border border-top border-left border-bottom border-right"
                                    colspan="4">
                                    <p class="s10 pl-1  text-left" style="margin-bottom: 0px;">Amount Payable by Due
                                        Date</p>
                                </td>
                            ...
                            <tr>
                                <td class="border border-top border-left border-bottom border-right"
                                    colspan="4">
                                    <p class="s10 pl-1  text-left" style="margin-bottom: 0px;">Surcharge
                            ...
                            <tr>
                                <td class="border border-top border-left border-bottom border-right"
                                    colspan="4">
                                    <p class="s10 pl-1  text-left" style="margin-bottom: 0px;">Amount Payable After Due
                                        Date</p>
                                </td>
                    ...
                    {{--                    <table class="mt-3 mt-3 float-left" style="margin-left:21pt; border-collapse: collapse;">--}}
                    {{--                        <tr>--}}
                    {{--                            <td>--}}
