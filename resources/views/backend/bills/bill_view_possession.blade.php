                    ...
                    <div class="card-body">
                        ...
                        <table style="margin-left:21pt; border-collapse: collapse;">
                            ...
                            <tr>
                                ...
                                <td class="border border-top border-left border-bottom border-right"
                                    style="width: 107pt;">
                                    <p class="s11  pl-1 text-left" style="margin-bottom: 0px;"> {{$bill->year}} </p>
                                </td>
                            </tr>
...
{{--                                    {{dd($billCharges->PlotCharges)}}--}}
                        ...
                        <table  style="width: 438pt; height: 173pt">

                            <tr>
                                <td class="border border-top border-left border-bottom border-right"
                                    colspan="4">
                                    <p class="s10 pl-1  text-left" style="margin-bottom: 0px;">Current Bill</p>
                                </td>

                                <td class="border border-top border-left border-bottom border-right"
                                    colspan="9">
                                    <p class="s11 pr-2  text-right" style="margin-bottom: 0px;">{{$bill->bill_total}}</p>
                                </td>
                            ...
                            <tr>
                                <td class="border border-top border-left border-bottom border-right"
                                    colspan="4">
                                    <p class="s10 pl-1  text-left" style="margin-bottom: 0px;">Arrears</p>
                                </td>

                                <td class="border border-top border-left border-bottom border-right"
                                    colspan="9">
                                    <p class="s11 pr-2  text-right" style="margin-bottom: 0px;"> {{$bill->arrears ?? '0'}} </p>
                                </td>
                            ...
                            <tr>
                                <td class="border border-top border-left border-bottom border-right"
                                    colspan="4">
                                    <p class="s10 pl-1  text-left" style="margin-bottom: 0px;">Amount Payable by Due Date</p>
                                </td>

                                <td class="border border-top border-left border-bottom border-right"
                                    colspan="9">
                                    <p class="s11 pr-2  text-right" style="margin-bottom: 0px;"> {{$bill->total}} </p>
                                </td>
                            ...
                            <tr>
                                <td class="border border-top border-left border-bottom border-right"
                                    colspan="4">
                                    <p class="s10 pl-1  text-left" style="margin-bottom: 0px;">Surcharge @Rs. {{getSettingValue('sub_charges')}}
                                        %
                                        After Due Date</p>
                                </td>
                                ...
                                <td class="border border-top border-left border-bottom border-right"
                                    colspan="9">
                                    <p class="s11 pr-2  text-right" style="margin-bottom: 0px;"> {{$bill->sub_charges}}</p>
                                </td>
                            ...
                            <tr>
                                <td class="border border-top border-left border-bottom border-right"
                                    colspan="4">
                                    <p class="s10 pl-1  text-left" style="margin-bottom: 0px;">Amount Payable After Due Date</p>
                                </td>

                                <td class="border border-top border-left border-bottom border-right"
                                    colspan="9">
                                    <p class="s11 pr-2  text-right" style="margin-bottom: 0px;">  {{$bill->sub_total}} </p>
                                </td>
                    ...
                    <div class="card-body">
                        ...
                        <table class=" mt-5 float-left" style="margin-left:21pt; border-collapse: collapse;">
                            <tr>
                                <td>
                                    <div></div>
                                </td>
