                        ...
                        <table style="margin-left:5.125pt; border-collapse: collapse;">
                            ...
                            <tr>
                                <td class="border  "
                                    style="width:389pt;"
                                    colspan=6>
                                    <p class="s10 pt-1 pl-4 pr-3 text-center" style="margin-bottom: 0px;">Bill Number</p>
                                </td>
                                <td class="border  "
                                    style="width: 437pt;"
                                    colspan="6">
                                    <p class="s12 pt-1 pl-3 text-left" style="margin-bottom: 0px;">*{{$bill->bill_number}}*</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="border  "
                                    style="width: 90pt;"
                                    colspan="2">
                                    <p class="s10 pt-1 pl-1 text-left" style="margin-bottom: 0px;">Account No.</p>
                                </td>

                                <td class="border border-top border-left border-bottom" style="width: 107pt;"
                                    colspan="2">
                                    <p class="s10 pt-1 pl-1 text-left" style="margin-bottom: 0px;">{{$bill->allotee->account_no}}</p>
                                </td>
                            ...
                            <tr>
                                <td class="border  "
                                    style="width: 90pt;"
                                    colspan="2">
                                    <p class="s10 pl-1 pt-1 text-left" style="margin-bottom: 0px;">Issue Date</p>
                                </td>
                                <td class="border  "
                                    style="width: 86pt;">
                                    <p class="s10 pt-1 pl-2 text-left" style="margin-bottom: 0px;">{{showDate($bill->issue_date)}}</p>
                            ...
                            <tr>
                                <td class="border  "
                                    style="width: 90pt;"
                                    colspan="2">
                                    <p class="s10 pl-1 pt-1 text-left" style="margin-bottom: 0px;">Due Date</p>
                                </td>
                                <td class="border  "
                                    style="width: 86pt;">
                                    <p class="s10 pt-1 pl-2 text-left" style="margin-bottom: 0px;">{{showDate($bill->due_date)}}</p>
                                </td>

                            </tr>

                        </table>
                        <table class="float-left" style="max-height: 300pt; margin-left:5.125pt; border-collapse: collapse;">

                            <tr>
                                <th class="border  "
                                    style="width: 253pt;"
                                    colspan="4">
                                    <p class="s10 pl-1 pt-1 text-center" style="margin-bottom: 0px;">Bill Duration</p>
                                </th>
                                <th class="border  "
                                    style="width: 70pt;"
                                    colspan="4">
                                    <p class="s10 pl-1 pt-1 text-center" style="margin-bottom: 0px;">Rate Per Marla</p>
                                </th>
                                <th class="border  "
                                    style="width: 70pt;"
                                    colspan="4">
                                    <p class="s10 pl-1 pt-1 text-center" style="margin-bottom: 0px;">No of Transfer</p>
                                </th>
                                <th class="border  "
                                    style="width: 70pt;"
                                    colspan="4">
                                    <p class="s10 pl-1 pt-1 text-center" style="margin-bottom: 0px;">Total Marla</p>
                                </th>
                                <th class="border   "
                                    style="width: 70pt;"
                                    colspan="4">
                                    <p class="s10 pl-1 pt-1 text-center" style="margin-bottom: 0px;">Total</p>
                                </th>
                            ...
                            <tr>
                                @foreach($bill->billCharges as $billCharges)
                                    ...
                                    <td class="border  "
                                        colspan="4">
                                        <p class="s10 pl-1 pt-1 text-left" style="margin-bottom: 0px;">{{$billCharges->fromMonth->name . ', ' .$billCharges->from_year . ' to ' .$billCharges->toMonth->name . ', ' .$billCharges->to_year   }}</p>
                                    </td>
                                    <td class="border  "
                                        colspan="4">
                                        <p class="s11 pr-1 pt-1 text-right" style="margin-bottom: 0px;">{{$billCharges->amount}}</p>
                                    </td>
                                    <td class="border  "
                                        colspan="4">
                                        <p class="s11 pr-1 pt-1 text-right" style="margin-bottom: 0px;">{{$billCharges->no_of_transfer}}</p>
                                    </td>
                                    <td class="border  "
                                        colspan="4">
                                        <p class="s11 pr-2 pt-1 text-right" style="margin-bottom: 0px;">{{$bill->allotee->size->value }}</p>
                                    </td>
                                    <td class="border  "
                                        colspan="4">
                                        <p class="s11 pr-2 pt-1 text-right" style="margin-bottom: 0px;">{{$billCharges->total}}</p>
                                    </td>
                            </tr>
                            @endforeach
                        ...
                        <table style="margin-left:5.125pt; border-collapse: collapse;">
                            ...
                            <tr class="h-14">
                                <td class="border  "
                                    style="width: 200pt;"
                                    bgcolor="">
                                    <p class="s10 pl-4 text-center line-height-9" style="margin-bottom: 0px;">Current Bill</p>
                                </td>

                                <td class="border  "
                                    style="width: 200pt;"
                                    colspan="3" bgcolor="">
                                    <p class="s10 pl-1 text-center line-height-9" style="margin-bottom: 0px;">Total Before Due Date</p>
                                </td>
                                <td class="border  "
                                    style="width: 200pt;"
                                    bgcolor="">
                                    <p class="s10 pl-3 text-center line-height-9" style="margin-bottom: 0px;">Surcharge
                                ...
                                <td class="border  "
                                    style="width: 200pt;"
                                    bgcolor="">
                                    <p class="s10 pl-3 text-center line-height-9" style="margin-bottom: 0px;">Total After Due Date</p>
                                </td>
                            </tr>
                            <tr class="h-14">
                                <td class="border  "
                                    style="width: 158pt;">
                                    <p class="s11 text-center line-height-9" style="margin-bottom: 0px;">{{$bill->total}}</p>
                                </td>

                                <td class="border  "
                                    style="width: 90pt;"
                                    colspan="3">
                                    <p class="s10 text-center line-height-9" style="margin-bottom: 0px;">{{$bill->total}}</p>
                                </td>
                                <td class="border  "
                                    style="width: 86pt;">
                                ...
                                <td class="border  "
                                    style="width: 107pt;">
                                    <p class="s10 text-center line-height-9" style="margin-bottom: 0px;">{{$bill->sub_total}}</p>
                                </td>
                            </tr>
                        ...
                        <table style="margin-left:5.125pt; border-collapse: collapse;">
                            ...
                            <tr class="h-14">
                                ...
                                <td class="border  "
                                    style="width: 200pt;"
                                    bgcolor="">
                                    <p class="s10 pl-3 text-center line-height-9" style="margin-bottom: 0px;">Surcharge</p>
                                </td>
                                <td class="border  "
                                    style="width: 200pt;"
                                    bgcolor="">
