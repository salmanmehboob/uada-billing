                        ...
                        <table style="margin-left:21pt; border-collapse: collapse;">
                            ...
                            <tr>
                                ...
                                <td class="border border-top border-left border-bottom" style="width: 95pt;"
                                    colspan="2">
                                    <p class="s13 pt-1 pl-1 text-left" style="margin-bottom: 0px;">{{$bill->allotee->account_no}}</p>
                                </td>
                            ...
                            <tr>
                                <td class="border border-top border-left border-bottom border-right"
                                    style="width: 90pt;"
                                    colspan="2">
                                    <p class="s11 pt-1 pl-2 text-left" style="margin-bottom: 0px;">{{showDate($bill->issue_date)}}</p>
                                </td>
                                <td class="border border-top border-left border-bottom border-right"
                                    style="width: 86pt;">
                                    <p class="s13 pt-1 pl-2 text-left" style="margin-bottom: 0px;">{{showDate($bill->due_date)}}</p>
                                </td>
                                <td class="border border-top border-left border-bottom border-right"
                                    style="width: 107pt;">
                        ...
                        <table style="margin-left:21pt; border-collapse: collapse;">
                            ...
                            <tr>
                                <th class="border border-top border-left border-bottom border-right"
                                    style="width: 389pt;"
                                    colspan="4">
                                    <p class="s10 pl-2 pt-1 text-left" style="margin-bottom: 0px;">Charges Description</p>
                                </th>
                                <th class="border border-top border-left border-bottom border-right"
                                    style="width: 146pt;"
                                    colspan="4">
                                    <p class="s10 pl-1 pt-1 text-left" style="margin-bottom: 0px;">Rate</p>
                                </th>
                                <th class="border border-top border-left border-bottom border-right"
                                    style="width: 146pt;"
                                    colspan="4">
                                    <p class="s10 pl-1 pt-1 text-left" style="margin-bottom: 0px;">Amount</p>
                                </th>
                                <th class="border border-top border-left border-bottom border-right"
                                    style="width: 145pt;"
                                    colspan="4">
                                    <p class="s10 pl-1 pt-1 text-left" style="margin-bottom: 0px;">Cost</p>
                                </th>
                            ...
                            <tr>
                                @foreach($bill->billCharges as $billCharges)
                                    ...
                                    <td class="border border-top border-left border-bottom border-right"
                                        colspan="4">
                                        <p class="s10 pl-1 pt-1 text-left" style="margin-bottom: 0px;">{{$billCharges->PlotCharges->charge->name}}</p>
                                    </td>
                                    <td class="border border-top border-left border-bottom border-right"
                                        colspan="4">
                                        <p class="s11 pr-1 pt-1 text-right" style="margin-bottom: 0px;">{{$billCharges->PlotCharges->amount}}</p>
                                    </td>
                                    <td class="border border-top border-left border-bottom border-right"
                                        colspan="4">
                                        <p class="s11 pr-2 pt-1 text-right" style="margin-bottom: 0px;">{{($billCharges->PlotCharges->is_period == 1) ? $bill->total_months .' X '. $billCharges->PlotCharges->amount : '' . $billCharges->PlotCharges->amount}}</p>
                                    </td>
                                    <td class="border border-top border-left border-bottom border-right"
                                        colspan="4">
