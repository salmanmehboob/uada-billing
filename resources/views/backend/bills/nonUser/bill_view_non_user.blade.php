                    ...
                    <div class="card-body">
                        <table style="margin-left:4pt; border-collapse: collapse;">
                            <tr class="border  ">
                                ...
                                <td class="" style="width:644pt;" colspan="6">
                                    ...
                                    <p style="padding-top: 1pt;text-indent: 0pt;text-align: center;margin-bottom: 0px;">
                                        <span class="s9"> Non User Charges Bill </span>
                                    </p>
                                    <p style="padding-top: 1pt;text-indent: 0pt;text-align: center;margin-bottom: 0px;">
                        ...
                        <table style="margin-left:4pt; border-collapse: collapse;">
                            ...
                            <tr>
                                ...
                                <td class="border border-top border-left border-bottom" style="width: 107pt;"
                                    colspan="2">
                                    <p class="s10 pt-1 pl-1 text-left"
                            ...
                            <tr>
                                ...
                                <td class="border  "
                                    style="width: 86pt;">
                                    <p class="s10 pt-1 pl-2 text-left"
                        ...
                        <table class="float-left"
                               style="max-height: 300pt; margin-left:4pt; border-collapse: collapse;">
                            ...
                            <tr>
                                ...
                                <th class="border  "
                                    style="width: 70pt;"
                                    colspan="4">
                                    <p class="s10 pl-1 pt-1 text-center" style="margin-bottom: 0px;">Rate Per Month</p>
                                </th>
                                <th class="border  "
                                    style="width: 70pt;"
                                    colspan="4">
                                    <p class="s10 pl-1 pt-1 text-center" style="margin-bottom: 0px;">Total Months</p>
                                </th>
                                <th class="border   "
                                    style="width: 70pt;"
                                    colspan="4">
                                ...
                                @foreach($bill->billCharges as $billCharges)
                                    ...
                                    <td class="border  "
                                        ...
                                        <p class="s10 pl-1 pt-1 text-left"
                                           style="margin-bottom: 0px;">{{$billCharges->fromMonth->name . ', ' .$billCharges->from_year . ' to ' .$billCharges->toMonth->name . ', ' .$billCharges->to_year   }}</p>
                                    </td>
                                    <td class="border  "
                                        colspan="4">
                                    ...
                                    <td class="border  "
                                        ...
                                        <p class="s11 pr-2 pt-1 text-right"
                                           style="margin-bottom: 0px;">{{$billCharges->total_months }}</p>
                                    </td>
                                    <td class="border  "
                                        colspan="4">
                                        <p class="s11 pr-2 pt-1 text-right"
                        ...
                        <table style="margin-left:4pt; border-collapse: collapse;">
                            ...
                            <tr class="h-14">
                                <td class="border  "
                                    style="width: 200pt;"
                                    bgcolor="">
                                    <p class="s10 pl-4 text-center line-height-9" style="margin-bottom: 0px;">Current
                                        Bill</p>
                                </td>
                                ...
                                <td class="border  "
                                    style="width: 200pt;"
                                    colspan="3" bgcolor="">
                                    <p class="s10 pl-1 text-center line-height-9" style="margin-bottom: 0px;">Total
                                        Before Due Date</p>
                                </td>
                                <td class="border  "
                                    style="width: 200pt;"
                                ...
                                <td class="border  "
                                    style="width: 200pt;"
                                    bgcolor="">
                                    <p class="s10 pl-3 text-center line-height-9" style="margin-bottom: 0px;">Total
                                        After Due Date</p>
                                </td>
                            </tr>
                            <tr class="h-14">
                                ...
                                <td class="border  "
                                    style="width: 90pt;"
                                    colspan="3">
                                    <p class="s10 text-center line-height-9"
                                       style="margin-bottom: 0px;">{{$bill->total}}</p>
                                </td>
                                <td class="border  "
                                    style="width: 86pt;">
                        ...
                        <table style="margin-left:4pt; border-collapse: collapse;">
                            ...
                            <tr class="h-14">
                                ...
                                <td class="border  "
                                    style="width: 200pt;"
                                    bgcolor="">
                                    <p class="s10 pl-3 text-center line-height-9" style="margin-bottom: 0px;">
                                        Surcharge</p>
                                </td>
                                <td class="border  "
                                    style="width: 200pt;"
