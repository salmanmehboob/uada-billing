...
@section('content')
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="{{route('show-bill-non-user')}}" class="breadcrumb-item">Bills</a>
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <!-- Registration form -->
            <form action="{{route('update-bill-non-user', $bill->id)}}" method="post"
                                                ...
                                                <div
                                                    ...
                                                    <select data-placeholder="Select Month" required
                                                        ...
                                                        @foreach($months as $key =>  $row)
                                                            <option  {{($charges->from_month == $row->id) ? 'selected' : ''}}
                                                ...
                                                <div
                                                    ...
                                                    <select data-placeholder="Select From Year" required
                                                        ...
                                                        @foreach ($years  as $row)
                                                            <option  {{($charges->from_year == $row) ? 'selected' : ''}} value="{{ $row }}">{{ $row }}</option>
                                                        @endforeach
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <div
                                                    ...
                                                    <select data-placeholder="Select Month" required
                                                        ...
                                                        <option></option>
                                                        @foreach($months as $key =>  $row)
                                                            <option  {{($charges->to_month == $row->id) ? 'selected' : ''}}
                                                                value="{{$row->id}}">{{$row->name}}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <div
                                                    ...
                                                    <select data-placeholder="Select To Year" required
                                                        ...
                                                        @foreach ($years  as $row)
                                                            <option  {{($charges->to_year == $row) ? 'selected' : ''}} value="{{ $row }}">{{ $row }}</option>
                                                        @endforeach
