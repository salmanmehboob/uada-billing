...
@section('content')
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="{{route('all-receipt-bill')}}" class="breadcrumb-item">Bill Transactions</a>
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <!-- Registration form -->
            <form action="{{route('store-receipt-bill')}}" method="post"
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3  ">
                                        <label class="col-form-label col-md-4">Issue Date<span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                <input type="text" readonly id="issue_date"
                                                       class="form-control"
                                                       placeholder=""
                                                       value="0"
                                                >
                                    ...
                                    <div class="col-md-3  ">
                                        <label class="col-form-label col-md-4">Due Date<span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                <input type="text" readonly id="due_date"
                                                       class="form-control"
                                                       placeholder=""
                                                       value="0"
                                                >
                                    ...
                                    <div class="col-md-3  ">
                                        <label class="col-form-label col-md-4">Total <span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                <input type="text"  readonly id="original_amount" name="original_amount"
                                                       class="form-control"
                                                       placeholder=""
                                                       value="0"
                                                >
                                    ...
                                    <div class="col-md-3  ">
                                        <label class="col-form-label col-md-4">Sub Total <span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                <input type="text" readonly id="due_amount" name="due_amount"
                                                       class="form-control"
                                                       placeholder=""
                                                       value="0"
                                                >
                                    ...
                                    <div class="col-md-4  ">
                                        <label class="col-form-label col-md-4">Payable Amount <span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                <input type="text" required name="payable_amount" id="total"
                                                       class="form-control"
            ...
            $('#bill_id').on('select2:select', function (e) {
                ...
                $.ajax({
                    ...
                    success: function (data, status, xhr) {
                        ...
                        var currentMonth = ("0" + (currentDate.getMonth() + 1)).slice(-2); // Adding 1 because months are zero-indexed
                        var currentDay = ("0" + currentDate.getDate()).slice(-2); // Adding zero-padding for single-digit days
                        var formattedCurrentDate = currentYear + "-" + currentMonth + "-" + currentDay;
                        var dueDate = data.responseData.due_date;
                        var issueDate = data.responseData.issue_date;

                         // Convert both dates to milliseconds since Jan 1, 1970, and compare
                        $('#original_amount').val(data.responseData.total);
                        $('#due_amount').val(data.responseData.sub_total);
                        $('#due_date').val(dueDate);
                        $('#issue_date').val(issueDate);
                        if (formattedCurrentDate <= dueDate) {
                            $('#total').val(data.responseData.total);
                        } else {
                            $('#total').val(data.responseData.sub_total);
                        }
                    },
                });
            });
