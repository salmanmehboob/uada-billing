                ...
                @foreach($bills as $bill)
                    <tr>
                         ...
                         <td>{{$bill->allotee->name .' ' . $bill->allotee->plot_no .$bill->sector->name}}</td>
                          <td>{{$bill->year}}</td>
                          <td>{{$bill->fromMonth->name .'-'.$bill->toMonth->name}}</td>
                          <td>{{$bill->total}}</td>
                         ...
                         <td>{{showBoolean($bill->is_paid)}}</td>
                          <td>
                            <div class="d-flex">
                                ...
                                <a  title="View"  href="{{ route('view-bill', $bill->id) }}"
                                    class="text-success mr-1"><i
                                        class="fas fa-eye"></i></a>
                                @if($bill->is_paid == 0 && $bill->is_active == 1)

                                <a  title="Edit"  href="{{ route('edit-bill', $bill->id) }}"
