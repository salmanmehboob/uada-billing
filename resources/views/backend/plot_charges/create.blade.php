...
@section('content')
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <!-- Registration form -->
            <form action="{{route('store-plotCharges')}}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <div
                                            ...
                                            <select required class="form-control select-search mb-3" name="size_id"
                                                    id="size_id">
                                    ...
                                    <div class="col-md-3">
                                        <label class="col-form-label  ">Select Charges <span
                                                class="text-danger">*</span> </label>
                                        <div
                                            class="form-group form-group-feedback form-group-feedback-right">
